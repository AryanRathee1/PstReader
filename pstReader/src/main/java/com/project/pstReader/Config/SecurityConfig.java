package com.project.pstReader.Config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auths -> auths // Authorize requests configuration
                        .requestMatchers("/api/user/**","/api/admin/**").permitAll() // Adjust your matchers accordingly
